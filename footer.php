    ...
    <div class="row row-cols-1 row-cols-lg-4 g-4">
      <div class="col">
        <div class="footer-widget-6">
          ...
          <p class="mb-2">Discover our curated selection of premium men’s watches, where timeless craftsmanship meets modern design for the perfect timepiece.</p>
      ...
      <div class="col">
        <div class="footer-widget-7">
          ...
          <ul class="widget-link list-unstyled">
            ...
            <li><a href="javascript:;">Luxury Men's Watches</a></li>
            <li><a href="javascript:;">Business Style</a></li>
            <li><a href="javascript:;">Watch Boxes & Accessories</a></li>
            <li><a href="javascript:;">Replacement Straps</a></li>
            <li><a href="javascript:;">Brands</a></li>
            <li><a href="javascript:;"> Limited Editions</a></li>
          </ul>
        </div>
      </div>
      <div class="col">
