...
// Xử lý cập nhật sản phẩm trước khi xuất HTML
...
<div class="container mt-5">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="images">Add Detail Images (multiple selection allowed)</label>
