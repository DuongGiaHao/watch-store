...
// Lấy danh mục để filter và chọn khi thêm/sửa sản phẩm
                            ...
                            <?php foreach ($products as $p): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="delete.php?id=<?= $p['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc muốn xóa?')">Xóa</a>
                                        <a href="images.php?id=<?= $p['id'] ?>" class="btn btn-info btn-sm">Ảnh</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
